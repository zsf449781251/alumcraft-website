(function () {
  ...
  const COPY = {
    en: {
      ...
      invalidToast: 'Please check the form fields and add enough project detail.'
    },
    ro: {
      sending: 'Se trimite…',
      sent: '✓ Cerere trimisă!',
      ...
      invalidToast: 'Verificați câmpurile și adăugați mai multe detalii despre proiect.'
    },
    pl: {
      sending: 'Wysyłanie…',
      ...
      invalidToast: 'Sprawdź pola formularza i dodaj więcej szczegółów projektu.'
    }
  };
  ...
  function errorMessage(copy, code, timedOut) {
    ...
    if (['invalid_email', 'invalid_input', 'input_too_long', 'input_too_short', 'missing_required'].includes(code)) {
